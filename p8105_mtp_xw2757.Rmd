...
```
Replaced missing values for [eop_size_mm] and [eop_shape] to "0". After initial cleaning of data, inspection of factor levels of categorical variables shows an uncategorized value in [eop_size], and an uncategorized value in [fhp_cat]. 
```{r}
accel <- accel %>% 
